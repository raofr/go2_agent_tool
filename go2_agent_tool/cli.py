...
from go2_agent_tool.client import ActionName, AudioUploadConfig, DetectionConfig, Go2SportClient
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="go2-agent-tool", description="GO2 gRPC CLI tool")
